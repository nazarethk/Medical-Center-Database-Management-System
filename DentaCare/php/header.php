  ...
  <body style="background-image: linear-gradient(to bottom right,#ffffff 0%, #2cbcbc 100%);">
      <div class="container" style="padding-top: 10px;">
        <nav class="navbar navbar-static-top" style="display: flex; justify-content: center;display: flex;">
          ...
          <a class="navbar-brand" style="margin-top:-12px;margin-bottom:10px;padding: 11px 13px;" href="../index.html">Denta<span>Care</span></a>
          
              <li class="nav-item">
                <a class="" href="https://goo.gl/GrHFNw" target="_blank"> <img src="../images/loc.png" style="max-width:5%;padding-right: 5px;"alt=""> DentaCare Medical Center, Beirut Lebanon</a>
              </li>
              <li class="nav-item">
